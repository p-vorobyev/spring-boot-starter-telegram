...
```kotlin
implementation("dev.voroby:spring-boot-starter-telegram:1.11.0")
```

Or just download artifact by path `Releases -> 1.11.0 -> dev.voroby.spring-boot-starter-telegram (maven) -> Assets -> spring-boot-starter-telegram-1.11.0.jar` 
